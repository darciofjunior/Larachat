...
export default {
    ...
    actions: {
        ...
        updatePhotoProfile ({dispatch}, formData) {
            ...
            return axios.post('/api/v1/profile/update_photo', formData, CONFIGS)
        ...
        toogleNotify ({ dispatch, state}) {
            return axios.patch('/api/v1/profile/update_preference', {
        ...
        updateImageChat ({dispatch}, formData) {
            formData.append('_method', 'PATCH')
            return axios.post('/api/v1/profile/update_image_chat', formData, CONFIGS)
                        .then(response => dispatch('getMe'))
        },

        removeImageChat ({dispatch}) {
            return axios.patch('/api/v1/profile/remove_image_chat')
                        .then(response => dispatch('getMe'))
        },
