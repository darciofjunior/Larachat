    ...
    <ul class="flex flex-col chat-list">
      <div v-for="(user, index) in users" :key="index">
        <li
          ...
          activeChat === 1 ? 'is-active' : 'bg-white' ]"
        >
...
<style scoped>
.chat-windows__messages-inner::-webkit-scrollbar-track {
    background-color: #dad7d7;
}
.chat-windows__messages-inner::-webkit-scrollbar {
    width: 6px;
    background: #dad7d7;
}
.chat-windows__messages-inner::-webkit-scrollbar-thumb {
    background: #3f51b5;
}
</style>
