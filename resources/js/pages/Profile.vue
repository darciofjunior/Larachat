<template>
    <div class="md:grid md:grid-cols-1 md:gap-6 p-8 over-flow-y-auto" style="max-height: 100vh;">
        ...
        <div class="bg-white shadow sm:rounded-md sm:overflow-hidden">
            <div class="p-6">
                <div class="col-span-6 sm:col-span-4 py-2">
                    ...
                    <input v-model="me.name" type="text" name="nome" id="nome" autocomplete="email" class="w-full px-3 py-2 placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300 dark:bg-gray-700 dark:text-white dark:placeholder-gray-500 dark:border-gray-600 dark:focus:ring-gray-900 dark:focus:border-gray-500">
                </div>
                <div class="col-span-6 sm:col-span-4 py-2">
            ...
            <div class="p-6">
                <div class="col-span-6 sm:col-span-4 py-2">
                    <label for="notifications">
                        <input @change="toogleNotify" v-model="me.preference.me_notify" type="checkbox" name="email_address" id="email_address" autocomplete="email" class="px-3 py-2 placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300 dark:bg-gray-700 dark:text-white dark:placeholder-gray-500 dark:border-gray-600 dark:focus:ring-gray-900 dark:focus:border-gray-500">
